describe('hashTable', function() {
  ...
  it ('should keep track of the number of values', function() {
    hashTable.insert('Amelia', 'Brown');
    expect(hashTable.counter).to.equal(1);
    hashTable.insert('Marco', 'Chan');
    hashTable.insert('Marco', 'Polo');
    expect(hashTable.counter).to.equal(2);
  });

  it ('should keep track of the number of values after removal', function() {
    hashTable.insert('Amelia', 'Brown');
    hashTable.insert('Marco', 'Chan');
    expect(hashTable.counter).to.equal(2);
    hashTable.remove('Marco');
    expect(hashTable.counter).to.equal(1);
  });
